...
function EtherSweepUI() {
	...
	function ICOScreen(id) {
		function Whitepaper() {
			...
			var ico = "<p class='ico_header'>ICO</p><p>The main goal of ICO is to raise funding for the promotion of the project, which will give you profit in the future. By buying " + symbol + " coins you are buying access to the contract balance, which consists of funds collected from ICO and 5% commission from each event reward. More bettors - more profit.</p><p>Tokens can be generated only while ICO is going on. Its price linearly increasing from $0.30 to $1.00 within 30 days. Contract owner getting 1.5x tokens that you bought. After ICO these tokens should not be more than 30% of the total supply, so half of them will be withdrawn and spent on the promotion and development of the project.</p>";
